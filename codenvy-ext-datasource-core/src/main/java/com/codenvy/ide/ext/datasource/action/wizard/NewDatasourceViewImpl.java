...
/**
 * The implementation of {@link NewDatasourceView}.
 * 
 * @author <a href="mailto:aplotnikov@codenvy.com">Andrey Plotnikov</a>
 */
public class NewDatasourceViewImpl extends Composite implements NewDatasourceView {
    interface NewDatasourceViewImplUiBinder extends UiBinder<Widget, NewDatasourceViewImpl> {
    }
    ...
    @Inject
    public NewDatasourceViewImpl(NewDatasourceViewImplUiBinder uiBinder) {
        initWidget(uiBinder.createAndBindUi(this));
    }

    @Override
    public void setConnectors(Array<DatasourceConnector> connectors) {
        ...
        for (int i = 0; i < connectors.size(); i++) {
            DatasourceConnector connector = connectors.get(i);
