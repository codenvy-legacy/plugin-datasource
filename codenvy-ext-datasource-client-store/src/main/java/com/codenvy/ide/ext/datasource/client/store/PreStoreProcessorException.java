...
/**
 * Exception class for post fetch processing errors.
 * 
 * @author "Mickaël Leduque"
 */
public class PreStoreProcessorException extends Exception {
    ...
    public PreStoreProcessorException(final Throwable cause) {
        super(cause);
    }
